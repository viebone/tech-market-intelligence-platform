...
| Job Function (added 2026-09-21 — the real breakdown of the `other`-bucket population: Sales, Marketing, Legal, Finance, ...) | ❌ not surfaced anywhere yet | ❌ no dedicated endpoint yet | ❌ Not exposed | Deferred, not decided against — same shape as "Market benchmark datasets" was before 2026-09-18: no real consumer surface (story, admin view, or ad-hoc query path) exists yet to decide MCP exposure against. A real `/data-surface-review` is the named next step (`changes/2026-09-21-emerging-role-detection.md`) before this row can be resolved either way. |
