...
**Answer was cut short before it finished:**
When a composed answer ended early (a length limit, a dropped stream), the Reasoning section
says so plainly as its final step — the answer was truncated, not completed — so a partial
answer is never presented in the panel as a finished one.
